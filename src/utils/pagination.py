...
class Paginator:
    def __init__(self, array: list|tuple, offset: int, page_callback: str, back_callback: str = None, _ = str) -> None:
        self.array = array
        self.offset = offset
    ...
    def getPageKeyboard(self, page: int) -> InlineKeyboardBuilder:
        ...
        if array_items_count > 0:
            ...
            if self.back_callback:
                keyboard.button(text=self._("⬅️ Back"), callback_data=self.back_callback)
